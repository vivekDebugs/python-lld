...
- When settling a group, we should try to minimize the number of transactions that the group members should make to
  ...
  **EqualSplittingStrategy(SplittingStrategy)**

  **PercentageSplittingStrategy(SplittingStrategy)**

  **CustomSplittingStrategy(SplittingStrategy)**

  **Group**
  - name
  - users: List[User]
  - expenses: List[Expense]
  - getSettlements(): List[Transaction]
  - settleTransactions(): None
  - createExpense(): Expense
  - splittingStrategyFactory(): SplittingStrategy
